<template>
<div>
	<vue-strap-table :count-per-page="5" :has-sort="true" v-ref:table :data.sync="data" @rowaction="rowaction" @getdata="getData" :columns.sync="columns"></vue-strap-table>
</div>
</template>
<script>
